...
alias mach-dev="eval '$(docker-machine env dev)' && docker-machine active dev"
alias mach-prod="eval '$(docker-machine env production)' && docker-machine active production"
